	...
	int goals, int cards, bool goalKeeper)
{
    ...
    *closest = -1;
	...
	{
		if (team->data->insertPlayer(playerId, gamesPlayed, goals, cards, goalKeeper, teamIdPtr, closest) == false)
		{
			return StatusType::FAILURE;
		}
	...
	else
	{
		...
		if (tempTeam->data->insertPlayer(playerId, gamesPlayed, goals, cards, goalKeeper, teamIdPtr, closest) == false)
		{
			return StatusType::FAILURE;
		}
	}
	...
	if (tempTeam->data->getPlayersCount() >= 11 && tempTeam->data->hasGoalKeeper())
	{
		...
		{
			currentTeam->data->insertPlayer(playerId, gamesPlayed, goals, cards, goalKeeper, teamIdPtr, closest);
		}
	}
